    ...
    render() {
        ...
        return (
            <div className="container dialog">
                ...
                >
                    <DialogTitle id="max-width-dialog-title">감귤 이미지 1차 분류(농민)</DialogTitle>        
                    <DialogContent>
                        <div className="item">
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(LabelDialog));